...
<html>
<head>
  <link href="<?php echo base_url(); ?>assets/admin/dist/datatables/dataTables.bootstrap.css" rel="stylesheet" type="text/css" />
...
<body class="skin-blue">
                 ...
                 <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                      <img style="width:80px;height:80px" src="<?php echo base_url(); ?>assets/admin/upload/<?php echo $row['foto']; ?>" class="img-circl" alt="User Image" />
                      </td>
  ...
  <!-- page script -->
    ...
    <script src="<?php echo base_url(); ?>assets/admin/dist/datatables/jquery.dataTables.js" type="text/javascript"></script>
    <script src="<?php echo base_url(); ?>assets/admin/dist/datatables/dataTables.bootstrap.js" type="text/javascript"></script>
